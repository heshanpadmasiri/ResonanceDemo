...
public class BluetoothServer {
    // Debugging
    private static final String TAG = "SafeAndSound";

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "SafeAndSoundSecure";
    private static final String NAME_INSECURE = "SafeAndSoundSecure";

    // Unique UUID for this application
    private static final UUID MY_UUID_SECURE =
            UUID.fromString("8828c726-277c-415d-9329-102e6eb77376");
    private static final UUID MY_UUID_INSECURE =
            UUID.fromString("b38d27c6-deba-4169-94ea-75a3fa21a962");
